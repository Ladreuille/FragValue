...
function wrapHtml(subject, innerHtml, baseUrl, unsubUrl) {
  // En prod, unsubUrl est un lien signe HMAC genere via api/_lib/email-unsub.js.
  // En preview, on utilise la page generique sans token = elle affiche un statut
  // "lien sans parametre" mais permet de visualiser le lien dans le footer.
