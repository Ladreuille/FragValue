...
(function () {
  ...
  const T_FR = {
    ...
    coachHub: 'QG coach mode', forStructures: 'Pour les structures', vodCoord: 'VOD Coordinator', praccCal: 'Pracc Calendar',
    soonBadge: 'BIENTÔT',
  ...
  const T_EN = {
    ...
    coachHub: 'Coach mode hub', forStructures: 'For structures', vodCoord: 'VOD Coordinator', praccCal: 'Pracc Calendar',
    soonBadge: 'SOON',
  ...
  const sections = [
    ...
    },
    {
      ...
      label: T.progresser,
      items: [
        { href: link('/progress.html'), label: T.maProgression, badge: 'pro' },
    ...
    },
    {
      ...
      items: [
        ...
        { href: link('/structures.html'), label: T.forStructures },
