...
export default async function handler(req, res) {
  ...
  try {
    ...
    const [
      ...
      supabase.from('demos').select('id', { count: 'exact', head: true }).gte('created_at', todayIso),
      supabase.from('demos').select('id', { count: 'exact', head: true }).gte('created_at', sevenIso),
      supabase.from('demos').select('id', { count: 'exact', head: true }).gte('created_at', thirtyIso),
